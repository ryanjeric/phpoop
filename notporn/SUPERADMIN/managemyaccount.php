...
<!DOCTYPE html>
  <html>
    ...
    <title>ManagemyAccount | SUPERADMIN</title>
    </head>
    ...
    if(isset($_POST['update']))
        {
         ...
         if(strlen($pass)<4 and strlen($pass)!=NULL){
          ...
          <?php
            ...
            if(!$emailcheck){
              $action = $function->updatemyaccount($id,$email,$pass,$fname,$lname,$mname,$address,$Company,$Contactno,$position,$status);
              if($action){        
                echo'<script type="text/javascript">alert("UPDATE SUCCESSFULL");</script>';
                echo'<script language="JavaScript"> window.location.href ="managemyaccount.php" </script>';
               }
               else{
                ?>
  ...
  ?>
              <div class="row">
                  <div class="col m12 white" style="padding:20px">
                      <h3 class="left-align lead"><i class="mdi-action-accessibility"></i>Update My Account</h3><hr>
                      <form method=POST>
                      <table>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td class="input-field col s6">
                              <input type="text" name="usertype" id="usertype" readonly value="<?php echo $account[11]; ?>" />
                        ...
                        <tr>                          
                          <td class="input-field col s6">
                            ...
                            <a href="index.php" class="btn waves-effect waves-yellow lead">
